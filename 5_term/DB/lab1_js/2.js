...
let schedule = [
  { time: "8.00 - 9.35", subject: " ", teacher: " ", auditorium: "" },
  { time: "9.45 - 11.20", subject: " ", teacher: " ", auditorium: "" },
  { time: "11.45 - 13.20", subject: " ", teacher: " ", auditorium: "" },
  {
    time: "13.30 - 15.05",
    subject: "чет. Структуры и алгоритмы обработки данных (л)",
    teacher: "доц. Зимин А.И",
    auditorium: "2226",
  },
  {
    time: "13.30 - 15.05",
    subject: "неч. Современные средства и методы front-end разработки (л)",
    teacher: "доц. Иванов К.С",
    auditorium: "2130б",
  },
  {
    time: "15.30 - 17.05",
    subject: "Современные средства и методы front-end разработки (лаб)",
    teacher: "доц. Иванов К.С",
    auditorium: "2130б",
  },
  {
    time: "17.15 - 18.50",
    subject: "Структуры и алгоритмы обработки данных (лаб)",
    teacher: "доц. Зимин А.И",
    auditorium: "2130а",
  },
];
